...
<body>
    <a href="#show-tekEvent" class="skip" tabindex="-1">
            ...
            <g:if test="${tekEventInstance?.name}">
                <li class="fieldcontain">
                    ...
                    <span class="property-value" aria-labelledby="name-label">
                        <g:fieldValue bean="${tekEventInstance}" field="name"/>
                    </span>
                </li>
            </g:if>
            ...
            <g:if test="${tekEventInstance?.endDate}">
                <li class="fieldcontain">
                    <span id="endDate-label" class="property-label"><g:message
                            code="tekEvent.endDate.label" default="End Date"/>
                    </span>
            ...
            <g:if test="${tekEventInstance?.sponsorships}">
                <li class="fieldcontain">
                    <span id="sponsorships-label" class="property-label"><g:message
                            code="tekEvent.sponsorships.label" default="Sponsorships"/>
                    </span>
